<template>
  <div>
    <b-card
      ...
      title="❤️ Helping CryptoNet By Staking ❤️"
      class="overflow-auto"
    >
      <b-table
        :items="pingVals"
...
export default {
  ...
  computed: {
    pingVals() {
      const cryptonet = this.list.filter(x => x.description.identity === '789E0A435C6E9C75' || x.description.identity === '985AC093BA2448204B6E487C789E0A435C6E9C75')
      return cryptonet
    },
    list() {
